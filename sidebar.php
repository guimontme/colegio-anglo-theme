	...
	?>
		<div class="bg-faded sidebar-nav">
			<div id="primary-two" class="widget-area">
				<?php
					$output = '<ul class="recentposts">';
						...
						if ( $recentposts_query->have_posts() ) :
							$output .= '<li><h3>' . esc_html__( 'Recent Posts', 'colegio-anglo' ) . '</h3></li>';
				...
				<br />
				<ul class="categories">
					<li><h3><?php esc_html_e( 'Categories', 'colegio-anglo' ); ?></h3></li>
					<?php
					...
					?>
							<li>&nbsp;</li>
							<li><a href="<?php echo esc_url( get_the_permalink( get_option( 'page_for_posts' ) ) ); ?>" class="btn btn-outline-secondary"><?php esc_html_e( 'more', 'colegio-anglo' ); ?></a></li>
					<?php
						endif;
					?>
				</ul>
